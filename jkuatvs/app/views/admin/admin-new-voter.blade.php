		        ...
		        <!-- /.contents goes in here -->
		          <!-- general form elements -->
                            <div style="padding-left:30px;" class="box box-primary">
                                ...
                                <!-- form start -->
                                <form role="form" action="{{URL::route('admin-new-voter-post')}}" enctype="multipart/form-data" method="post" style="width:85%">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Registration Number</label>
                                            <input type="text" class="form-control" required="required" name="Identity_No" placeholder="Registration Number">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="Phone_Number" required="required" maxlength="10" placeholder="Phone Number">
