            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li class="active">
                            <a href="{{URL::route('super-admin-home-get')}}">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-folder"></i> <span>Administrators</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="{{URL::route('super-admin-new-admin-get')}}"><i class="fa fa-angle-double-right"></i>New Administrator</a></li>
                                <li><a href="{{URL::route('super-admin-view-admins-get')}}"><i class="fa fa-angle-double-right"></i>View Administators</a></li>
                            </ul>
                        </li>
                         <li class="active">
